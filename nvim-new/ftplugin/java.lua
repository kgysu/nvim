...
config.settings = {
  java = {
    ...
    format = {
      enabled = true,
      settings = {
        url = home .. "/.config/nvim/lspconfig/intellij-code-style-formatting.xml",
        profile = "Default",
      },
    },
    eclipse = {
      ...
      runtimes = {
        {
          ...
          --             name = "JavaSE-21",
          --             path = "/Users/kevin/.sdkman/candidates/java/current/bin/java",
        },
      },
    },
...
config.cmd = {
  ...
  "-configuration",
  home .. "/.local/share/nvim/mason/packages/jdtls/" .. archConfigName(),
  "-data",
  workspace_dir,
}
